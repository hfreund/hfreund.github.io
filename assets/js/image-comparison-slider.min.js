! function(e) {
    ...
    t = e.exports = n(2)(), t.push([e.id, ".slide-comparison{width:900px;height:345px;position:relative;overflow:hidden}.slide-comparison img{display:block;width:100%;height:100%}.slide-comparison .resized{position:absolute;top:0;left:0;height:100%;width:50%;overflow:hidden}.slide-comparison .divider{position:absolute;left:50%;top:0;bottom:0;width:4px;margin-left:-2px;background:rgba(0,0,0,.5)}@media (max-width:767px){.slide-comparison{width:300px;height:200px}}@media (min-width:768px and max-width:899px){.slide-comparison{width:300px;height:200px}}", ""])
}, function(e, t) {
    e.exports = function() {
        var e = [];
